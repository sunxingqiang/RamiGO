getAmigoTree <- function(goIDs, color, pvalues, pcolors = c("white","tomato"), psplit = c(1,0.25,0.1,0.05,0.001), filename, picType = "png", modeType = "advanced", webserver, saveResult = TRUE)
{
